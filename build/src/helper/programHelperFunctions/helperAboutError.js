...
var helperAboutError = {
    throwErrorToDiscord: function (targetChannel, content, description, fields) {
        targetChannel.send(embedMessageMaker_1.embedMessageMaker("" + content, "ErrorRepoter", (description !== undefined) ? description : "", (fields !== undefined) ? fields : [], new Date(), embedMessageMaker_1.embedMsgState.Error));
    }
};
