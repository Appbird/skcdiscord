...
function executeCmd(msg) {
    ...
    //機能が存在するか
    var usedFunctionIndex = functionSet_1.default.findIndex(function (func) { return tokenArray[0] === func.functionName.toLowerCase(); });
    ...
    var selectedCmdIndex = functionSet_1.default[usedFunctionIndex].commands.findIndex(function (cmd) { return cmd.commandTitle.toLowerCase() === tokenArray[1]; });
