    ...
    StandardDataManager.getCmdChannelId = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, helperAboutFiles_1.default.fetchJSONDataFromDiscordDataBase("standard.json")];
                    case 1:
                        data = _a.sent();
                        if (data === undefined)
                            return [2 /*return*/, []];
                        return [2 /*return*/, data.cmdChannelId];
                }
            });
        });
    };
    StandardDataManager.addCmdChannelId = function (channelId) {
        return __awaiter(this, void 0, void 0, function () {
            var cmdChannelId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, addCmdChannelIdState.success];
                }
            });
        });
    };
    StandardDataManager.removeCmdChannelId = function (removedId) {
        return __awaiter(this, void 0, void 0, function () {
            var cmdChannelId, lengthBeforeProcess;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, StandardDataManager.getCmdChannelId()];
                    case 1:
                        cmdChannelId = _a.sent();
                        lengthBeforeProcess = cmdChannelId.length;
                        cmdChannelId = cmdChannelId.filter(function (element) { return element !== removedId; });
                        if (lengthBeforeProcess === cmdChannelId.length)
                            return [2 /*return*/, removeCmdChannelIdState.notChannelFound];
                        this._save(cmdChannelId);
                        return [2 /*return*/, removeCmdChannelIdState.success];
                }
            });
        });
    };
    StandardDataManager._save = function (cmdChannelId) {
        helperAboutFiles_1.default.saveJSONFromDiscordDataBase("standard.json", {
            "cmdChannelId": cmdChannelId
        });
    };
    return StandardDataManager;
}());
exports.StandardDataManager = StandardDataManager;
